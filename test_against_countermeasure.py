    ...
    for dataset in datasets:
        if countermeasure =="padding_linear_2":
            ...
            Countermeasure_params = [{"alg":"padding_cluster","knum_in_cluster":1},\
                ...
                {"alg":"padding_cluster","knum_in_cluster":32}]
            our_attack_params={
                    "alg": "Ours",
                    "refinespeed":refspeed,
                    "alpha":0.2,
...
if __name__ == "__main__":
    ...
    #     test_times=30,kws_uni_size=500,datasets=["enron","lucene"],kws_extraction="sorted")
    run_Ours_IHOP_and_RSA_against_countermeasure("obfuscation",\
       test_times=10,kws_uni_size=1000,datasets=["enron"],kws_extraction="sorted")


    # run_Ours_IHOP_and_RSA_against_countermeasure("padding_linear_2",\
    #     test_times=10,kws_uni_size=3000,datasets=["wiki"],kws_extraction="sorted",observe_query_number_per_week=5000,observe_weeks=30,time_offset=0,refspeed=50)
    # run_Ours_IHOP_and_RSA_against_countermeasure("obfuscation",\
