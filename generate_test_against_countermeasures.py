...
def generate_against_countermeasures(dataset,countermeasure,kws_uni_size,test_times=30,legend=True):
    ...
    plt.savefig("results/test_against_countermeasures/"+dataset+"_"+countermeasure+"_"+str(kws_uni_size)+".pdf",pad_inches=0.0, bbox_inches = 'tight')
    plt.show()

if __name__ == "__main__":
    generate_against_countermeasures("wiki","padding",1000,test_times=10)
