...
if __name__ == "__main__":
    comparison(30,"enron",Query_number_per_week=[100,500,25000],Kws_uni_size=[100,1000,2000],observed_time=50,eta=50)
    comparison(30,"lucene",Query_number_per_week=[100,500,25000],Kws_uni_size=[100,1000,2000],observed_time=50,eta=50)
